<div class="d-flex justify-content-center">
    <span x-text="data[key]" class="pl-2 pr-2 border-none rounded"
        :class="{
            ...
            'tw-text-red-700 tw-bg-red-200':        data[key] === 'Hỏng',
            'tw-text-yellow-500 tw-bg-yellow-200':  data[key] === 'Đang sửa chữa',
            'tw-text-green-500 tw-bg-green-200':    data[key] === 'Hoàn thành sửa chữa',
        }"
        :style="
