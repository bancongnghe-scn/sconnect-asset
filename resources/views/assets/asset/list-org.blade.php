...
<div x-data="listAsset" style="margin: 0px 15px;">
    <div class="row" >
        <div class="card">
            <div class="card-body">
                <div class="tab-container" style="border-bottom: 1px solid #e3e3e3 !important;">
                    <div class="@if (Route::currentRouteName() == 'assets.listUserAsset') tab-item-active @else tab-item @endif" onclick="location.href='{{ route('assets.listUserAsset') }}'">
                        Nhân viên
                    </div>
                    <div class="@if (Route::currentRouteName() == 'assets.listOrgAsset') tab-item-active @else tab-item @endif" onclick="location.href='{{ route('assets.listOrgAsset') }}'">
                        Đơn vị
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center" style="gap: 8px;">
                                            <span style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modalDetail" @click="fillData(org); tab = 'allocation-tab'; tabAllocation = 'allocation-tab'">
                                            ...
                                            <span style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modalDetail" @click="fillData(org); tab = 'allocation-tab'; tabAllocation = 'recovery-tab'">
                                                <svg width="21" height="23" viewBox="0 0 21 23" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('listAsset', () => ({
            ...
            async fetchData(unit = '', nameUser = '') {
                try {
                    let urlSearch = '/api/asset/get-data-list-org-asset?';
            ...
            async getDataAssetOfUser() {
                try {
                    let urlSearch = '/api/asset/get-list-asset-of-org?orgId=' + this.orgObj.id;
