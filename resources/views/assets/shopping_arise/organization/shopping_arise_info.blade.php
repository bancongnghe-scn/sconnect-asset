<div x-data="{ isDisabled: @json($view === 'detail'), isDetail: @json($view === 'detail')}">
    <div>
        <div class="mb-3 active-link tw-w-fit">Thông tin chung</div>
        <div>
            <label>Nội dung<span class="tw-ml-1 tw-text-red-600 mb-0">*</span></label>
            <textarea class="form-control" x-model="data.name" placeholder="Nhập nội dung mua sắm" :disabled="isDisabled"></textarea>
        </div>
    </div>
    ...
    <div class="mt-3">
        ...
        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
            <table id="example2" class="table table-bordered dataTable dtr-inline" aria-describedby="example2_info">
                ...
                <tr>
                    ...
                    <th class="text-center" style="width: 3rem;" x-show="!isDetail"></th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <input class="form-control" type="number" min="1"
                                   x-model="value.quantity_registered" :disabled="isDisabled">
                        </td>
                        <td class="align-middle">
                            @include('common.select_custom.extent.select_single', [
                        ...
                        <td class="align-middle">
                            <input class="form-control" type="text"
                                   x-model="value.description" :disabled="isDisabled">
                        </td>
                        <td class="text-center align-middle" x-show="!isDetail">
        ...
        <button @click="addRowAsset" type="button" class="btn btn-sm btn-sc" x-show="!isDetail">Thêm hàng</button>
    </div>
