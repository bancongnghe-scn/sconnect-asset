<div class="modal fade" id="modalInsertPlanMaintain" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Thêm mới kế hoạch bảo dưỡng</h4>
                        ...
                        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4 mt-3">
                            <div class="row">
                                    ...
                                    <table id="example2" class="table table-bordered dataTable dtr-inline" aria-describedby="example2_info">
                                        ...
                                        <template x-for="(value, key) in data.assets_maintain">
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                  <span class="tw-cursor-pointer" @click="data.assets_maintain.splice(key,1)">
                                ...
                                <div class="d-flex justify-content-end tw-gap-x-3">
                                    ...
                                    <button class="btn btn-sc" @click="create()">Tạo lịch bảo dưỡng</button>
                                </div>
                            </div>
                        </div>
                    </div>
