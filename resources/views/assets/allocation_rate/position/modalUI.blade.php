<div class="modal fade" id="modalUIPosition" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body overflow-auto custom-scroll tw-h-[40rem]">
                <div class="tw-grid tw-grid-cols-2 tw-gap-x-3">
                    ...
                    <div>
                        <label class="form-label">Chức danh<label class="tw-text-red-600 mb-0">*</label></label>
                        @include('common.select_custom.extent.select_single', [
