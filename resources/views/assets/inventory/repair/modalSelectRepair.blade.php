                ...
                <div class="container mb-3">
                    ...
                    <table id="" class="table table-bordered table-hover dataTable dtr-inline"
                        ...
                        <tr>
                            ...
                            <template x-for="(columnName, key) in dataTheadModalRepairtMore">
                                <th rowspan="1" colspan="1" x-text="columnName"></th>
                            </template>
                        </tr>
                        </thead>
                        <tbody>
                        <template x-for="(data,index) in dataModalRepairtMore" x-data="{line: 1}">
                            <tr>
        ...
        return {
            ...
            selectedAllAsset() {
                ...
                this.dataModalRepairtMore.forEach(
                    (item) => {
                        this.selectedRepairtMore[item.id] = this.checkedAll
                    }
                )
            }
        }
