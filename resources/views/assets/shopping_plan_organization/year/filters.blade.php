            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-3 align-items-end form-group">
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control yearPicker" x-model="filters.time" placeholder="Chọn năm" autocomplete="off">
                    </div>
                    <div class="col-2">
                        <label class="tw-font-bold">Trạng thái</label>
                        <select class="form-control select2" id="filterStatusOrganization" multiple="multiple" data-placeholder="Chọn trạng thái">
