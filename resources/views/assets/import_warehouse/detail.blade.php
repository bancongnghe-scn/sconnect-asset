...
@section('x-data')
    x-data="import_warehouse_detail({{$id}})"
@endsection

@section('btn-header')
    <a class="btn btn-warning" href="/import-warehouse/list">Quay lại</a>
@endsection
        ...
        <div>
            <div class="tw-grid tw-grid-cols-4 tw-gap-4 mb-3">
                ...
                <div class="tw-col-span-1">
                    ...
                    <input class="form-control" type="text" x-model="data.name" placeholder="Tên phiếu" disabled>
                </div>
                ...
                <div class="tw-col-span-4">
                    <label>Ghi chú</label>
                    <textarea class="form-control tw-h-40" x-model="data.description" placeholder="Nhập ghi chú" disabled></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <table id="example2" class="table table-bordered dataTable dtr-inline" aria-describedby="example2_info">
                ...
                <template x-for="(asset,index) in data.shopping_assets" :key="index">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="number" min="1" x-model="asset.warranty_time" disabled>
                        </td>
                        <td>
                            <input class="form-control" type="text" x-model="asset.seri_number" disabled>
                        </td>
...
@section('js')
    @vite([
        'resources/js/assets/import-warehouse/import_warehouse_detail.js',
