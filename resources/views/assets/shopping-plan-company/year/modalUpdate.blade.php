<div class="modal fade" id="idModalUpdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button @click="edit" type="button" class="btn btn-sc">Lưu</button>
            </div>
        </div>
    </div>
</div>
