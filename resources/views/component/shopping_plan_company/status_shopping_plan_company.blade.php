<span x-text="STATUS_SHOPPING_PLAN_COMPANY[{{$status}}]" class="p-1 border rounded"
      :class="{
            ...
            'tw-text-green-900 tw-bg-green-100'  : +{{$status}} === STATUS_SHOPPING_PLAN_COMPANY_APPROVAL || +{{$status}} === STATUS_SHOPPING_PLAN_COMPANY_COMPLETE,
            'tw-text-red-600 tw-bg-red-100'  : +{{$status}} === STATUS_SHOPPING_PLAN_COMPANY_CANCEL,
            'tw-text-amber-400 tw-bg-amber-100'  : +{{$status}} === STATUS_SHOPPING_PLAN_COMPANY_HR_HANDLE
