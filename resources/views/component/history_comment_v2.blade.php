<div x-data="history_comment">
    ...
    <div class="mt-3 overflow-y-scroll overflow-x-hidden custom-scroll" style="border-top: 1px solid" x-show="activeLink.history">
    ...
    <div class="mt-3" style="border-top: 1px solid" x-show="activeLink.comment">
        <div class="mt-3 container" id="comment">
            <div class="overflow-y-scroll custom-scroll">
...
{{--                                        <span class="text-xs opacity-50 ml-2" x-text="comment.created_at"></span>--}}
                                        <span class="tw-font-bold" style="color: #2067B0;">SupperAdmin</span>
                                        <span class="text-xs opacity-50 ml-2">12/10/2024</span>
                                    </div>
{{--                                    <span x-text="comment.message"></span>--}}
                                    <span>Hoang oiiiiiiiii</span>
                                </div>
                            </div>
                            <div class="tw-ml-12">
